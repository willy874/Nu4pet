...
const wss = new SocketServer({
    server: app.listen(port, () => {
        ...
        console.log('Pet List',`http://localhost:${port}/pet-list.html`.blue)
        console.log('Pet Base',`http://localhost:${port}/pet-base.html`.blue)
        console.log('Pet Base Edit',`http://localhost:${port}/pet-base-edit.html`.blue)
        console.log('Pet-Nutrition',`http://localhost:${port}/pet-nutrition.html`.blue)
        console.log('Pet-Record',`http://localhost:${port}/pet-record.html`.blue)
